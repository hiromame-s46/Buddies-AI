...
1. `public_html/AI/`の中身を、サーバーの`public_html/AI/`へアップロードします。
...
```text
https://あなたのドメイン/AI/lfm_setup.php?key=変更したキー
```
...
```bash
curl -X POST 'https://あなたのドメイン/AI/lfm-api.php' \
